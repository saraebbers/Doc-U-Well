...
class Schedule extends Component {
  ...
  handleSubmit() {
    ...
    const { userFirst, userLast, dob, blood, height, weight, bps, bpd, hr, date, time, ap, provider, providerFirst, providerLast, phone, streetAddress, city, state, zip, kind, specialty, insuranceType, polNum, insurancePhone, groupNumber, carrier, notes } = this.state
    let text
    switch (type) {
      case 'profile' :
